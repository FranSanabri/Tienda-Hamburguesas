...
const HamburgersWithoutTaccList = ({ agregarAlCarrito }) => {
  const hamburgersWithoutTacc = [
    {
      ...
      price: 10.99,
      image: 'http://ilsole.com.ar/wp-content/uploads/2016/07/figacitas-sin-tacc-sin-gluten-il-sole-768x509.jpg',
    },
    {
      id: 2,
      ...
      price: 9.99,
      image: 'https://recetasfitness10.com/wp-content/uploads/2018/08/burguer.jpeg',
    },
    ...
    <div className="hamburgers-without-tacc-list">
      {hamburgersWithoutTacc.map((hamburger) => (
        <div className="hamburger" key={hamburger.id} id='sintacc'>
          ...
          <button onClick={() => agregarAlCarrito(hamburger)}>Agregar al carrito</button>
        </div>
      ))}
    </div>
  );
